...
import { fetchUserPickups } from "../../services/activityService";

const mockUser = { id: "mockUserId" }; // Replace with real user from auth context/state
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-500">
              A record of your past and scheduled pickups.
            </p>
          </div>
        </div>
            ...
            {userPickups.map((pickup) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`inline-flex items-center gap-2 px-3 py-1 text-sm font-semibold rounded-full ${bgColor} ${textColor}`}
                  >
